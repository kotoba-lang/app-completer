// completer.etzhayyim.com — DID Compliance Actor
// Thin-edge dispatcher: business logic in AgentGateway MCP + pod-side LangServer.
// 7 methods: evaluate / evaluateRepoDids / remediate /
//            getAuditReport / listFindings / listAudits / getComplianceScore
...
const NSID_PREFIX = "com.etzhayyim.apps.completer.";
const ACTOR_DID = "did:web:completer.etzhayyim.com";
  ...
  async fetch(req: Request, env: Env): Promise<Response> {
    ...
    if (url.pathname === "/health" || url.pathname === "/_app/meta") {
      return json({
        ok: true,
        actor: ACTOR_DID,
        nanoid: env.APP_NANOID ?? "ktugb754",
        execution: "edge-proxy+agentgateway-mcp+langserver",
        bpmn: "60-apps/etzhayyim-project-completer/bpmn",
        methods: [
          "evaluate", "evaluateRepoDids", "remediate",
          "getAuditReport", "listFindings", "listAudits", "getComplianceScore",
        ],
      });
    }
